    ...
    return jQuery
        ...
        E = y.JSON; (function(p) {
                ...
                a.d[b] = {
                    init: function(b, k, h, l, g) {
                        ...
                        a.w(function() {
                            ...
                            n = !c !== !q,
                            r = !x;
                            if (r || d || n !== m) r && a.Z.oa() && (x = a.a.la(a.e.childNodes(b), !0)),
                            n ? (r || a.e.T(b, a.a.la(x)), a.Ja(e ? e(g, q) : g, b)) : a.e.ma(b),
                            m = n
                        },
                        null, {
                            q: b
            ...
            a.a = function() {
                ...
                function() {
                    for (var a = 3,
                    b = w.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "<!--[if gt IE " + ++a + "]><i></i><![endif]-->", c[0];);
                    return 4 < a ? a: p
                } (),
                m = /\S+/g;
                return {
                    ...
                    o: function(a, b) {
                        for (var c = 0,
                        g = a.length; c < g; c++) b(a[c], c)
                    },
                    m: function(a, b) {
                        if ("function" == typeof Array.prototype.indexOf) return Array.prototype.indexOf.call(a, b);
                        for (var c = 0,
                        g = a.length; c < g; c++) if (a[c] === b) return c;
                        return - 1
                    },
                    vb: function(a, b, c) {
                        for (var g = 0,
                        d = a.length; g < d; g++) if (b.call(c, a[g], g)) return a[g];
                        return null
                    },
                    ya: function(b, c) {
                        var g = a.a.m(b, c);
                    ...
                    T: function(b, c) {
                        a.a.Ra(b);
                        if (c) for (var g = 0,
                        d = c.length; g < d; g++) b.appendChild(c[g])
                    },
                    Qb: function(b, c) {
                    ...
                    qa: function(b, c) {
                        ...
                        else if ("function" == typeof w.createEvent) if ("function" == typeof b.dispatchEvent) g = w.createEvent(h[c] || "HTMLEvents"),
                    ...
                    Ia: function(b, c, g) {
                        var d;
                        c && ("object" === typeof b.classList ? (d = b.classList[g ? "add": "remove"], a.a.o(c.match(m),
                        function(a) {
                    ...
                    Ha: function(b, c) {
                        var g = a.a.c(c);
                        if (null === g || g === p) g = "";
                        var d = a.e.firstChild(b); ! d || 3 != d.nodeType || a.e.nextSibling(d) ? a.e.T(b, [b.ownerDocument.createTextNode(g)]) : d.data = g;
                        a.a.mc(b)
                    },
                    Rb: function(a, b) {
                        a.name = b;
                    ...
                    M: g,
                    Db: function(b, c) {
                        for (var g = a.a.O(b.getElementsByTagName("input")).concat(a.a.O(b.getElementsByTagName("textarea"))), d = "string" == typeof c ?
                        function(a) {
                            return a.name === c
                        }: function(a) {
                    ...
                    zc: function(c, g, d) {
                        ...
                        s.action = f;
                        s.method = "post";
                        for (var p in g) c = w.createElement("input"),
                        c.type = "hidden",
                        c.name = p,
            ...
            function() {
                ...
                function d(c) {
                    ...
                    if (f[c.nodeType]) for (e = c.firstChild; c = e;) e = c.nextSibling,
                    8 === c.nodeType && d(c)
                }
                var c = a.a.f.I(),
                e = {
            ...
            a.r = function(b) {
                function d() {
                    if (0 < arguments.length) return d.Wa(c, arguments[0]) && (d.X(), c = arguments[0], d.W()),
                    this;
                    a.k.Ob(d);
                    return c
                }
            ...
            a.ba.fn = {
                remove: function(b) {
                    for (var d = this.B(), c = [], e = "function" != typeof b || a.F(b) ?
                    function(a) {
                        return a === b
                    }: b, f = 0; f < d.length; f++) {
                        var k = d[f];
                    ...
                    b.yb = function(b, d, f) {
                        ...
                        if (c && !k) {
                            ...
                            case "splice":
                                ...
                                for (var r = 1 === v ? r: Math.min(d + (f[1] || 0), r), v = d + v - 2, t = Math.max(r, v), G = [], A = [], p = 2; d < t; ++d, ++p) d < r && A.push(l("deleted", b[d], d)),
            ...
            a.w = a.j = function(b, d, c) {
                ...
                I = !1,
                s = !1;
                A && "object" == typeof A ? (c = A, A = c.read) : (c = c || {},
                A || (A = c.read));
                ...
                g.ua = function(b) {
                    G || "change" != b || g.Ba("change") || (a.a.A(B,
                    function(a, b) {
                        b.p && (B[a] = {
                            da: b.da,
                            sa: b.sa,
                    ...
                    Ea: function(e, g) {
                        function m(b, g) {
                            ...
                            if (!r) {
                                ...
                                if (l = h[b]) e = g,
                                0 <= a.a.m(d, e) ? e = !1 : (l = e.match(c), e = null === l ? !1 : l[1] ? "Object(" + l[1] + ")" + l[2] : e),
                                l = e;
            ...
            a.b("virtualElements.setDomNodeChildren", a.e.T); (function() {
                a.L = function() {
                    this.ec = {}
                };
            ...
            a.b("bindingProvider", a.L); (function() {
                ...
                function l(b) {
                    ...
                    function I(e) {
                        if (!d[e]) {
                            ...
                            f && (f.after && (g.push(e), a.a.o(f.after,
                            function(c) {
                                if (b[c]) {
                ...
                function g(b, c, g, e) {
                    ...
                    if (c && "function" !== typeof c) h = c;
                        ...
                        n = a.j(function() { (h = c ? c(g, b) : x.call(k, b, g)) && g.K && g.K();
                            return h
                        },
                        null, {
                            q: b
                ...
                a.N.prototype.extend = function(b) {
                    return new a.N(this.K || this.$data, this, null,
                    function(c, d) {
                        c.$rawData = d.$rawData;
                ...
                n = a.a.f.I();
                a.Tb = function(b, c) {
                    if (2 == arguments.length) a.a.f.set(b, n, c),
                    c.K && c.K.Zb(b);
                ...
                function d(d, e) {
                    ...
                    m;
                    g ? g.U(e) : (g = f[d] = new a.Q, g.U(e), c(d,
                    function(a, b) {
            ...
            a.d.css = {
                update: function(b, d) {
                    var c = a.a.c(d());
                    null !== c && "object" == typeof c ? a.a.A(c,
                    function(c, d) {
                        d = a.a.c(d);
                        a.a.Ia(b, c, d)
            ...
            a.d.options = {
                ...
                update: function(b, d, c) {
                    ...
                    g && ("undefined" == typeof g.length && (g = [g]), q = a.a.xa(g,
                    function(b) {
            ...
            a.d.selectedOptions = {
                ...
                update: function(b, d) {
                    ...
                    var c = a.a.c(d());
                    c && "number" == typeof c.length && a.a.o(b.getElementsByTagName("option"),
                    function(b) {
                ...
                init: function(b, d, c) {
                    if ("input" != b.tagName.toLowerCase() || "checkbox" != b.type && "radio" != b.type) {
                        ...
                        var l = function() {
                            ...
                            g = a.i.s(b);
                            a.h.ra(e, c, "value", g)
                        }; ! a.a.M || "input" != b.tagName.toLowerCase() || "text" != b.type || "off" == b.autocomplete || b.form && "off" == b.form.autocomplete || -1 != a.a.m(e, "propertychange") || (a.a.n(b, "propertychange",
                        function() {
                            k = !0
                        }), a.a.n(b, "focus",
                        function() {
            ...
            a.b("__tr_ambtns", a.kb.dc); (function() {
                ...
                function b(b, c, d) {
                    var e;
                    for (c = a.e.nextSibling(c); b && (e = b) !== c;) b = a.e.nextSibling(e),
                    d(e, b)
                }
                function d(c, d) {
                    if (c.length) {
                ...
                a.d.template = {
                    ...
                    update: function(b, c, d, e, f) {
                        ...
                        f = e; (r = a.a.f.get(b, h)) && "function" == typeof r.p && r.p();
            ...
            a.b("utils.compareArrays", a.a.Ma); (function() {
                ...
                a.a.fb = function(c, e, f, k, h) {
                    ...
                    function g(b, c) {
                        if (b) for (var d = 0,
                        e = c.length; d < e; d++) c[d] && a.a.o(c[d].aa,
                        function(a) {
                            b(a, d, c[d].wa)
                        })
                    }
                    ...
                    for (var C = 0,
                    m = a.e.firstChild(c), H; s = y[C]; C++) {
                        s.aa || a.a.extend(s, b(c, f, s.wa, h, s.Ua));
                        for (v = 0; n = s.aa[v]; m = n.nextSibling, H = n, v++) n !== m && a.e.Fb(c, n, H); ! s.rc && h && (h(s.wa, s.aa, s.Ua), s.rc = !0)
                    }
                    g(k.beforeRemove, e);
                    g(k.afterMove, z);
                    g(k.afterAdd, q);
            ...
            a.P.Va = new a.P;
            a.hb(a.P.Va);
            a.b("nativeTemplateEngine", a.P); (function() {
                a.Ya = function() {
...
var debug = function() {
    if (window.console && window.console.debug) return function() {
...
function toggleDropDown(toggle, dropdown) {
    ...
    if ($(dropdown).is(":hidden")) {
        display = "block";
        $(toggle).addClass("active").css({
            "z-index": 10
        });
        $("#overlay").show().css("opacity", 0).data("element", dropdown).data("block", false)
    }
    $(dropdown).css({
        display: display,
...
function modal(id, options) {
    ...
    if (options.close) {
        ...
        $("#overlay").show().css("opacity", 1).data("element", id).data("block", typeof options.block === "undefined" ? false: true);
        $(id).show().css({
...
$(function() {
    ...
    function() {
        if ($(this).data("block") == false) {
            ...
            $('a[data-id="' + $(this).data("element") + '"]').removeClass("active").css({
                "z-index": 5
            })
        }
    });
    ...
    function(e) {
        ...
        if ($submenu.length > 0) {
            ...
            if (offset.top > 0 && offset.left > 0 && (e.clientX < offset.left || e.clientX > offset.left + width || e.clientY > offset.top + height)) {
